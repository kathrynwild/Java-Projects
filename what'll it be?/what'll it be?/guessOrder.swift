...
@IBDesignable class guessOrder: UIStackView {
    ...
    private func setupButtons() {
        ...
        for _ in 0..<starCount {
            ...
            button.addTarget(self, action: #selector(guessOrder.ratingButtonTapped(button:)), for: .touchUpInside)
